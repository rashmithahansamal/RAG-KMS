...
class LLMService:
    ...
    # NEW: Method for selective tracing with custom project names
    def get_response_with_custom_tracing(self, query, project_name="custom-project"):
        try:
            # NEW: Use context manager for selective tracing with custom project
